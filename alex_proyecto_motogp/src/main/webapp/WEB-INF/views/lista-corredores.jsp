...
<div class="container">
	...
	<table class="table table-stripped">
		<thead>
			<th><a class="nav-link " href="list-alumno?orden=nombre"><%-- <spring:message code="etiqueta.nombre" /> --%>
			</a></th>
			<th><a class="nav-link " href="list-alumno?orden=dni"><%-- <spring:message code="etiqueta.dni" /> --%></a></th>


			<th><a class="nav-link " href="list-alumno?orden=edad"><%-- <spring:message code="etiqueta.edad" /> --%>
			</a></th>

			<th><a class="nav-link " href="list-alumno?orden=modulo"><%-- <spring:message code="etiqueta.ciclo" /> --%>
			</a></th>
			

			<th><a class="nav-link " href="list-alumno?orden=curso"><%-- <spring:message code="etiqueta.curso" /> --%>
			</a></th>

			<th><a class="nav-link " href="list-alumno?orden=erasmus"><%-- <spring:message code="etiqueta.erasmus" /> --%> </a></th>
						<th><a class="nav-link " href="#"><%-- <spring:message code="etiqueta.modificado" /> --%> </a></th>
...
<p>	<a  class="btn btn-success" href="add-alumno"><i class="fas fa-user-plus"></i>&nbsp;<spring:message code="boton.nuevo" /></a></p></div>
